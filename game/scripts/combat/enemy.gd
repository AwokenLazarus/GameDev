...
## Basic Dominion foe. Human variant can be fed upon after death.
...
func _apply_role_visuals() -> void:
	...
	if is_human:
		visual.color = Color(0.62, 0.48, 0.4)
	elif is_elite:
		visual.color = Color(0.55, 0.15, 0.55)
	else:
		visual.color = xp_color
